(function() {
    tinymce.PluginManager.add('agilecrm_content_management_button', function( editor, url ) {
        editor.addButton( 'agilecrm_content_management_button', {
            text: 'Agile Forms',
            icon: false,
            onclick: function() {
            jQuery.ajax({
                ...
                editor.windowManager.open( {
                    ...
                    onsubmit: function( e ) {
                        editor.insertContent( '[agileform_email_marketing id="' + e.data.form+ '"]');
                    }
                });
                }
            });
